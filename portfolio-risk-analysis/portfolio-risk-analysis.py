...
# === FIX 2: Correct weights validation ===
...
# === FIX 3: Correct date logic + message ===
if end_date >= date.today():
    print("The end date must be earlier than today. Please check the value you entered.")
    exit()
